...
**Current process version:** 1.13 (2026-08-14)
...
You want something closer to **course notes**: clear learning outcomes, a ranked reading list, structured digests of the core sources, themes that show where claims come from, and a path for what to do next. You care that citations are real and that “consensus” is treated as a claim, not as the floor.
...
- **Sources** — ranked Core / Important / Supplementary list with selection criteria and citation practice  
...
- **Further reading** — concrete next steps, not a dump of titles  
...
| **Bibliography** | Useful annotated list | Substantially richer, positioned annotations |
...
2. **Provenance is non-negotiable** — major claims in themes back-link to digests or primary sources.  
...
- Not a guarantee of perfect scholarship — it is a structured research process that makes evidence and gaps visible.  
...
See **[changelog.md](changelog.md)** for version history (Deep mode, anti-bias practices, completeness gates, dual-layer artwork digests, Period-Specialist Analysis, etc.).
