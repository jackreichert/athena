...
Load this file when the package shape is **Deep**.
...
## Phase adaptations
### Phase 0
Declare package shape = Deep. Digests in scope. Learning outcomes oriented toward seminar-level participation and critical engagement.
